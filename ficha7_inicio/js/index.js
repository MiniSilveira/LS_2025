...
const LinguagensScript = ({nome})=> {
  return (
    <h1 style={styleH1}>Bem vindo '{nome} a UC de Linguagens Script!</h1>
  )
}
...
ReactDOM.render(
  <React.StrictMode>
    <LinguagensScript nome="Ana Antunes"/>
    <LinguagensScript nome="José Antunes"/>
    <LinguagensScript nome="Antónia Antunes"/>
    <LinguagensScript nome="Rita Antunes"/>
  </React.StrictMode>,
  containerRoot
);*/
...
function App(){
  return (
    <div class="container">
      <InfoComponent title="React" src="images/react.png" url=
" https://react.dev/"> React is a
...
“properties”), and returns a hierarchy of views to display via the render method.
      ...
      <InfoComponent title="Javascript" src=
      ...
      <InfoComponent title="Vue" src=
      "images/vue.png"
      url="https://vuejs.org/">
      Vue is a JavaScript framework for building user interfaces. It is built on top of standard
  ...
  return(
    <div class="wrapper">
        ...
        <div class="text">
          ...
          <a href={url} target="_blank">Ler mais</a>
        </div>
      </div>
  )
}
